 ...
 * 
 * 💡 구현된 수학 모듈 리스트:
 * 1. Header: 상단 칠판 로고 및 네비게이션
 * 2. Hero: 아날로그 칠판 메인 세션
 * 3. EquationGame: 60초 일차방정식 스피드 랭킹 게임 & Supabase 명예의 전당
 * 4. ProportionGraph: 정비례·반비례 그래프 탐구기 & Supabase 연동
 * 5. BlindOmok: (0,0) 중심 좌표평면 순서쌍 블라인드 오목 게임
 * 6. Footer: 카피라이트 & 선생님 응원 코멘트
 */
